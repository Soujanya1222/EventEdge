        ...
        <div className="dashboard-container">
            ...
            <div className="stats-container">
                <div className="dashboard-card organiser">
                    ...
                    <button className="dashboard-btn" onClick={()=>navigate("/organiserList")}>View Organiser</button>
                </div>
                ...
                <p>Pending Events</p>
                <h2>{pendingCount}</h2>
                 <button className="dashboard-btn" onClick={()=>navigate("/organiser/events?status=pending")}>View pending Events</button>
                </div>
                
                <div className="dashboard-card approved">
                <p>Approved Events</p>
                <h2>{approvedCount}</h2>
                 <button className="dashboard-btn" onClick={()=>navigate("/organiser/events?status=approved")}>View Approved Evets</button>
                </div>
                ...
                <p>Rejected Events</p>
                <h2>{rejectedCount}</h2>
                 <button className="dashboard-btn" onClick={()=>navigate("/organiser/events?status=rejected")}>View Rejected Events</button>
                </div>
